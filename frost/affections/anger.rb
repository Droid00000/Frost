  ...
  def self.anger(data)
    ...
    data.respond(ephemeral: false) do |builder|
      ...
      builder.add_embed do |embed|
        ...
        embed.description = format(RESPONSE[1], data.member("target").display_name)

        # This is going to be the random GIF of the action we're performing.
        embed.image = Discordrb::Webhooks::EmbedImage.new(url: ANGRY.sample)
      end
    end
  end
end
