  ...
  def self.bonk(data)
    ...
    data.respond(new_components: true) do |_, builder|
      ...
      builder.container(color: to_color(data.user)) do |container|
        ...
        container.text_display(text: HEADERS[2])
        ...
        container.text_display(text: format(RESPONSE[5], data.user.display_name,
        ...
        container.media_gallery { |media| media.gallery_item(media: BONK.sample) }
      end
    end
  end
end
