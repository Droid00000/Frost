...
require_relative 'endpoints/frost'
  ...
  module API
    ...
    class Client
      ...
      def update_rate_limits(route, response)
        @rl_info[route.rate_limit_key] =
          @rl_info[response.headers['x-ratelimit-bucket']] if response.headers['x-ratelimit-bucket']
